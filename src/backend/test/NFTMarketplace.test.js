// Tests for NFT & Marketplace 
// Testing framework - waffle provided by hardhat 
// Chai Assertion library - to compare return and expecting values 

const { expect } = require("chai");


// can't represent decimal values in solidity , have to represent ether in smart contracts as its smallest division way 
// 1 ether = 10**18 wei
